...
import drinkLogo from '../../assets/images/myNavLogo.png';
import { AuthCheck } from 'reactfire';

const useStyles = makeStyles({
    logo: {
        content: `url(${drinkLogo})`,
        maxWidth: '20%',
        height: 'auto',
    },
    navlogo: {
            ...
            <div className={` ${classes.width60} ${classes.alignCenter} `}>
                <ul className={` ${classes.ul} ${classes.row} ${classes.spaceBetween} ${classes.psides}`}>
                    ...
                    <AuthCheck fallback={
                        ...
                        <li>
                            <Button>
                                <Link to='/Dashboard' className={`${classes.navbarItem} ${classes.psides} `}>Available Drinks</Link>
                            </Button>
                        </li>
                        <li>
                            <Button>
